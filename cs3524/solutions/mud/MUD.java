...
public class MUD {
    ...
    // String coresponds to  location/vertex name
    public Map<String, String> users = new HashMap<String, String>();
    // user_name , List of items
    public Map<String, List<String>> userItems = new HashMap<String, List<String>>();    
     ...
     */
    void createThing(String loc, String thing) {
    ...
    public boolean thingExists(String location,String thing)
    {
